...
waitForBBW().then(() => {
  ...
  // Add bg
  document
    .querySelector(".document-wrapper")
    .insertAdjacentHTML(
      "afterbegin",
      `<div class="bbw_video_bg" style="position:fixed; top:${-bbwBgHeight}px; left: 0; width:100vw; height:${bbwBgHeight}px; z-index: 200; opacity: 0; background: #122779; pointer-events: none; transform-origin: top;"><div style="position: absolute; top: 4px; right: 4px; width: 24px; height: 24px; font-size: 1.4rem; color: #FF5C57; text-align: center; display:flex; justify-content:center; align-items:center;"><i class="fa fa-times"></i></div></div>`
    );
