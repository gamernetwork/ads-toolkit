...
CubeAd.prototype.TB_VERSION = 0.925;
...
CubeAd.prototype.setNode = function(targetNode, nodeData)
{
    ...
    else if(nodeData.hasOwnProperty('img'))
    {
        if(nodeData.hasOwnProperty('url'))
        {
			...
			img.setAttribute("class", "default-img-face");
        ...
        else
        {
			...
			cubeImg.setAttribute("class", "default-img-face");
 ...
 */
CubeAd.prototype.onFirstUserInteraction = function()
{
	
};

CubeAd.prototype.getFaceInView = function()
{
	var angle = this.xDeg % 360;
	angle = (angle + 360) % 360;
	return Math.floor(angle / 90);
};

CubeAd.prototype.roundCube = function(bias)
{
