...
function videoLightbox(el, analytics, site) {
  // Youtube Iframe api
...
var src_init = function init(props, clickUrlEsc) {
  ...
  !props.dev && !document.querySelector('#ad-wrapper').getAttribute('rel').includes('halfpage') && applyBaseStyles({
    site: props.site,
  ...
  appendLightboxSource(); // syncIframes(props.site, props.skinImg, props.dev);
